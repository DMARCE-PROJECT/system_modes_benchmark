...
// Nav2 node with two non-default modes: weak and strong
class Nav2 : public rclcpp_lifecycle::LifecycleNode
{
public:
  Nav2()
  : LifecycleNode("nav2")
  {
    ...
    this->declare_parameter("forbidden_areas", false);
...
int main(int argc, char * argv[])
{
  ...
  auto driver = std::make_shared<system_modes_benchmark::Nav2>();
