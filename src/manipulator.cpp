...
class Manipulator : public rclcpp_lifecycle::LifecycleNode
{
public:
  Manipulator()
  : LifecycleNode("manipulator")
  {
    ...
    this->declare_parameter("max_torque", 0.5);
...
int main(int argc, char * argv[])
{
  ...
  auto manipulator = std::make_shared<system_modes_benchmark::Manipulator>();
