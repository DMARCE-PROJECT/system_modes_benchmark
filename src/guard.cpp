...
// Guard node with two non-default modes: weak and strong
class Guard : public rclcpp_lifecycle::LifecycleNode
{
public:
  Guard()
  : LifecycleNode("guard")
  {
    ...
    this->declare_parameter("compromised_system", false);
...
int main(int argc, char * argv[])
{
  ...
  auto driver = std::make_shared<system_modes_benchmark::Guard>();
